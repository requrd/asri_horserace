...
class HorsePillar(Base):
    ...
    speedrank = relationship(
        "SpeedRankData", uselist=False, backref="racehorse", lazy="joined"
    )
    recommend = relationship(
        "RecommendData", uselist=False, backref="racehorse", lazy="joined"
    )
    result = relationship(
        "SeisekiData", uselist=False, backref="racehorse", lazy="joined"
    )
    # 馬情報
    num = Column(Integer)
    waku = Column(Integer)
    ...
    zenso1_time_min = Column(Integer)
    zenso1_time_sec = Column(Integer)
    ...
    zenso2_time_min = Column(Integer)
    zenso2_time_sec = Column(Integer)
    ...
    zenso3_time_min = Column(Integer)
    zenso3_time_sec = Column(Integer)
    ...
    zenso4_time_min = Column(Integer)
    zenso4_time_sec = Column(Integer)
    ...
    zenso5_time_min = Column(Integer)
    zenso5_time_sec = Column(Integer)
...
class BangumiData(Base):
    ...
    returninfo = relationship(
        "Returninfo", uselist=False, backref="race", lazy="subquery"
    )
    # レース情報
    ymd = Column(String)
...
class SpeedData(Base):
    __tablename__ = "speed"
    racehorsekey = Column(
        String, ForeignKey("horsepillar.racehorsekey"), primary_key=True
    )
