...
class RacehorseData(baseobj):
    ...
    #1:1
    trainanalysis = relobj("TrainAnalysisData",uselist=False, backref=bkrobj("racehorse"),innerjoin=True)
    ...
    hobokusakiidx = relobj("HobokusakiIndex",uselist=False,backref=bkrobj("racehorse"))
    ...
    zenso1 = relobj("SeisekiData",uselist=False,foreign_keys=[zenso_seiseki_key_1],innerjoin = False)
    zenso2 = relobj("SeisekiData",uselist=False,foreign_keys=[zenso_seiseki_key_2],innerjoin = False)
    zenso3 = relobj("SeisekiData",uselist=False,foreign_keys=[zenso_seiseki_key_3],innerjoin = False)
    zenso4 = relobj("SeisekiData",uselist=False,foreign_keys=[zenso_seiseki_key_4],innerjoin = False)
    zenso5 = relobj("SeisekiData",uselist=False,foreign_keys=[zenso_seiseki_key_5],innerjoin = False)
