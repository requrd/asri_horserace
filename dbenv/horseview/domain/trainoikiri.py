...
class TrainOikiriData(baseobj):
    ...
    num=colobj(intobj)
    oikiristateidx = relobj("OikiriStateIndex",uselist=False,backref=bkrobj("train_oikiri"))
    traincoureidx = relobj("TrainCourseCodeIndex",uselist=False,backref=bkrobj("train_oikri"))
